...
import com.saranya.tripguideapp.AllTourAttractions.TourAttractionsList;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        touristDestinations_models.add(new TouristDestinations_MODEL(R.drawable.delhi, "New Delhi", "Delhi"));
        touristDestinations_models.add(new TouristDestinations_MODEL(R.drawable.jaipur, "Jaipur", "Rajasthan"));
        ...
        touristAttractions_models.add(new TouristAttractions_MODEL(R.drawable.agra, "Taj Mahal", "Agra, Uttar Pradesh"));
